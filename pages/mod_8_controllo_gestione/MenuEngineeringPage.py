...
class MenuEngineering(BasePage):
    def __init__(self, page:Page):
        super().__init__(page)

        # --- FILTRI ---
        self.btn_genera_dati = page.get_by_role("button", name="Genera Dati")
        self.btn_aggiorna = page.get_by_role("button", name="Aggiorna Analisi")
        self.btn_visualizza = page.get_by_role("button").filter(has_text=re.compile(r"^$")).nth(4)
...
# ============================================================
    ...
    def apri_menu_engineering(self):
        self.apri_gruppo_menu("Controllo Gestione")
        self.naviga_a("/cost-control/menu-engineering")
...
# ============================================================
    def seleziona_da_drop(self):
            ...
            """
            opzioni_periodo = ["Ultimo Mese", "Ultimo Trimestre", "Ultimo Anno"]
            ...
            trigger = self.page.get_by_role(
                "button",
                name=re.compile(r"Ultimo Mese|Ultimo Trimestre|Ultimo Anno")
            )
            trigger.click()
